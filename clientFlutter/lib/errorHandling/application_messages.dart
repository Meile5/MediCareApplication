...
enum ApplicationMessages{
  serverError("Server error occurred. Our team has been notified and is working on a fix."),
  networkError("Unable to connect to server. Please check your internet connection and try again."),
  authenticationError("Invalid username or password. Please check your credentials and try again."),
